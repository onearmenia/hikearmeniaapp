...
class Module implements AutoloaderProviderInterface, ConfigProviderInterface
{
    ...
    public function onBootstrap(MvcEvent $e)
    {
        ...
        $eventManager->getSharedManager()->attach(array('Admin\Controller\AdminController', 'Admin\Controller\AdminActionController', 'Admin\Controller\AdminAjaxController'), 'dispatch', function ($e) {
