...
- (void)viewWillLayoutSubviews
{
    ...
    else
    {
        ...
        //_labelTitle.preferredMaxLayoutWidth = _windowWidth - 24.0f;
        _labelTitle.frame = CGRectMake(12.0f + self.contentView.frame.origin.x, kTitleTop + self.contentView.frame.origin.y, _windowWidth - 24.0f, [self getLabelHeight:_labelTitle]);
    }
...
- (void)slideInFromTop
{
    if (SYSTEM_VERSION_LESS_THAN(@"7.0"))
    {
        ...
        [UIView animateWithDuration:0.8f delay:0.0f usingSpringWithDamping:0.6f initialSpringVelocity:0.5f options:0 animations:^{
            self.backgroundView.alpha = _backgroundOpacity;
