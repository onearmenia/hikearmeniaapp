...
import static com.hikearmenia.util.SmoothProgressBarUtils.checkColors;
import static com.hikearmenia.util.SmoothProgressBarUtils.checkNotNull;
import static com.hikearmenia.util.SmoothProgressBarUtils.checkPositive;
import static com.hikearmenia.util.SmoothProgressBarUtils.checkPositiveOrZero;
import static com.hikearmenia.util.SmoothProgressBarUtils.checkSpeed;

/**
 * Created by Astghik on 6/29/16.
 */
...
public class SmoothProgressDrawable extends Drawable implements Animatable {
    ...
    public static class Builder {
        ...
        private void initValues(Context context, boolean editMode) {
            ...
            mSectionsCount = 1; //res.getInteger(R.integer.spb_default_sections_count);
