...
public class YoYo {
    ...
    private YoYo(AnimationComposer animationComposer, int mDuration) {
    ...
    public static final class AnimationComposer {
        ...
        public YoYoString playOn(View target, int mDuration) {
            this.target = target;
            return new YoYoString(new YoYo(this, mDuration).play(), this.target);
        }
